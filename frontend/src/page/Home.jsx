...
function Home() {
  ...
  return (
    <>
      <div
        className={`justify-center pt-14 ${CSS_H_W_full} ${CSS_flexCol} ${CSS_color_lightest}`}
      >
        <div
          className={`w-8/10 md:w-8/10 h-9/10 justify-between ${CSS_generalBorder} ${CSS_flexCol}`}
        >
          <div
